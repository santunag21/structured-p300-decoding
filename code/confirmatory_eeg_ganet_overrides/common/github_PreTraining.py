...
def train(dataset_conf, train_conf, results_path):
    ...
    for sub in range(0,6):  # (num_sub): for all subjects, (i-1,i): for the ith subject.
        ...
        for train_idx in range(n_train):  # How many repetitions of training for subject i.
            ...
            filepath = filepath + '/run_{}.weights.h5'.format(train_idx + 1)
        ...
        filepath = '/saved models/subject_{}/run_{}.weights.h5'.format(sub + 1, best_run + 1) + '\n'
...
def test(model, dataset_conf, results_path):
    ...
    for sub in range(0,6):  # (num_sub): for all subjects, (i-1,i): for the ith subject.
        ...
        best_run = filepath[filepath.find('run_') + 4:filepath.find('.weights.h5')]
